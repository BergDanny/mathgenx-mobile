...
const setupAnimation = () => {
    ...
    // Hide default cursor immediately on mount
    ...
    // Trigger initial cursor position update
    // This ensures cursor responds immediately without waiting for mouse movement
    ...
    setTimeout(triggerInitialUpdate, 50);
