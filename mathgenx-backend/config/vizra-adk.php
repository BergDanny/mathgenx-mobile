...
return [
     ...
     */
    'tracing' => [
        'enabled' => env('VIZRA_ADK_TRACING_ENABLED', false),
    ...
    'vector_memory' => [
         ...
         */
        'enabled' => env('VIZRA_ADK_VECTOR_ENABLED', false),
